...
// docs/coding-standards.md H6; single-sourced here by D5 after shipping as a
// per-app copy in #129). Attach the returned callback as the overlay's `ref`
// and it:
//
...
//   2. traps Tab/Shift-Tab inside, and pulls escaped focus back (ignoring
//      dialogs stacked later, e.g. a confirm over a form);
