...
const I = {
  dashboard: (
    <svg className="ico" width="19" height="19" viewBox="0 0 24 24" fill="none">
      <path
        d="M3 11l9-8 9 8M5 10v9a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-9"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
  ...
  contacts: (
    <svg className="ico" width="19" height="19" viewBox="0 0 24 24" fill="none">
      <path
        d="M4 4h16a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1ZM1 8h2M1 12h2M1 16h2"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  campaigns: (
    <svg className="ico" width="19" height="19" viewBox="0 0 24 24" fill="none">
      <path
        d="m3 11 15-7v16L3 13v-2ZM3 11v2M7 12.5V18a1 1 0 0 0 1 1h2"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  automations: (
    <svg className="ico" width="19" height="19" viewBox="0 0 24 24" fill="none">
      <path
        d="M13 2 4.5 12.5h6L11 22l8.5-10.5h-6L13 2Z"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  coupons: (
    <svg className="ico" width="19" height="19" viewBox="0 0 24 24" fill="none">
      <path
        d="M20 12V8H4v4M20 12v8H4v-8M20 12H4M12 7v13"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  lists: (
    <svg className="ico" width="19" height="19" viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="m3 6 1 1 2-2M3 12l1 1 2-2M3 18l1 1 2-2"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <aside className={drawerOpen ? "sidebar sidebar--open" : "sidebar"}>
        ...
        <Link href="/profile" className="sidebar-me" title="Your profile">
          ...
          <span className="sidebar-me-main">
            <span className="sidebar-me-name">
