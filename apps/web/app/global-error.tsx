...
// Last-resort boundary for an error thrown in the ROOT layout itself, which the
// normal error.tsx cannot reach. It REPLACES <html>/<body>, so it can't use the
// app chrome or globals.css — styles are inlined with the Spark ink palette so
// it stays branded and dependency-light even when everything else is broken.
