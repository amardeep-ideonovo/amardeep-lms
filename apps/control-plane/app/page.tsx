...
// Mockup cover art. Self-hosted from public/art — these previously hotlinked
// masterclass.com's course images, i.e. a competitor's copyrighted artwork
// served off their CDN on our own public marketing page. Generated by
// packages/db/prisma/assets/generate-demo-art.ts (regenerate + re-copy the
// four -0 panels if the palette changes).
const COVER_MUSIC = "/art/demo-music-0.png";
const COVER_COOKING = "/art/demo-food-0.png";
const COVER_SPORTS = "/art/demo-sports-0.png";
const COVER_TECH = "/art/demo-technology-0.png";
            ...
            <div className="bmock-body">
              ...
              <div className="bmock-grid">
                {[
                  ...
                  { base: "42,124,72", cover: COVER_SPORTS, pct: 85 },
                ].map((c) => (
                  <div
                    key={c.cover}
